...
const VideoDetection = () => {
  ...
  return (
    <div className="flex flex-col w-[84%] overflow-auto  h-screen sm:w-[87%] md:w-[89%] border absolute right-0 z-10">
      ...
      <h1 className="mt-10 text-xl sm:text-2xl xl:text-4xl font-semibold text-center  ">YOLO V8 for seamless video detection...</h1>
        ...
        <div className='flex space-x-3 items-center justify-center w-fit mx-auto mb-4'>
        {video && (
            <div className='mt-6'>
